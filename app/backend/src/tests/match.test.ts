...
describe('Testa a rota /matches', () => {
  describe('Retorna todas as partidas', () => {
    ...
    it('Testa se retorna todas as partidas utilizando a rota /matches', async () => {
...
describe('Testa a rota /matches ', () => {
  describe('Retorna todas as partidas em andamento', () => {
    ...
    it('Testa se a retorna um array de matches que estao em andamento', async () => {
  ...
  describe('Retorna todas as partidas finalizadas', () => {
    // @ts-ignore
    before(async () => {
      sinon.stub(Matches, 'findAll').resolves(matchesFinished as any);
    });
    // @ts-ignore
    after(()=>{
      (Matches.findAll as sinon.SinonStub).restore();
    ...
    it('Testa se a retorna um array de matches que estao finalizadas', async () => {
